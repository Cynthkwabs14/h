...
#Plot 1 Automobile sales fluctuate over Recession Period (year wise)
        ...
        yearly_rec=recession_data.groupby('Year')['Automobile'].mean().reset_index()
        R_chart1 = dcc.Graph(
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unempl_rate = recession_data.groupby('Vehicle_Type', 'unemployment_rate')['Automobile_Sales'].mean().reset_index()
        R_chart4 = dcc.Graph(
            figure=px.bar(unempl_rate, 
            x='unemployment_rate', 
            y ='automobile_Sales', 
            color ='Vehicle_Type', 
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ssg = data.groupby('Automobile_Sales')['Month'].mean().reset_index()
        Y_chart2 = dcc.Graph(
            figure=px.line(ssg, 
            x= 'Automated_sales', 
            y='Month', 
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data, values='Vehicle_Type', name='Advertising_Expenditure', title='Total Advertisement Expenditure for each vehicle'))
